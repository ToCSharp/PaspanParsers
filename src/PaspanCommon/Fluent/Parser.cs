...
{
    public abstract bool Parse(ref SpanReader reader, ParseContext context, ref ParseResult<T> result);
    ...
    /// </summary>
    public Parser<Unit> Discard() => new Discard<T, Unit>(this, Unit.Value);
